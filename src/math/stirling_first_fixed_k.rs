...
mod tests {
    ...
    use crate::math::{prime_mod::Prime, stirling_first_table::stirling_first_table};
    ...
    fn test() {
        let n = 100;
        let ans = stirling_first_table(n, ConstModIntBuilder::new());

        for k in 0..=n {
            assert_eq!(
                stirling_first_fixed_k::<P>(n, k),
