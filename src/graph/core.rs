...
impl<W, I> Edge<W, I> {
    pub(crate) fn new(from: usize, to: usize, weight: W, index: usize, option: I) -> Self {
        Self {
            from,
            to,
            weight,
...
pub struct Graph<D, W, I> {
    pub(crate) nodes: Vec<GraphNode<W, I>>,
    edge_num: usize,
